...
int main(int argc,char *argv[]){
  if (argc!=4) 
  {
    ...
    printf("Example:/root/weather/idc1/bin/crtsurfdata2 /root/weather/idc1/ini/stcode.ini /tmp/surfdata /log/idc/crtsurfdata2.log\n\n");
...
bool LoadSTCode(const char *inifile){
  ...
  while(true){
    ...
    memset(strBuffer,0,sizeof(strBuffer));//每次都清空缓冲区，否则易出现bug
